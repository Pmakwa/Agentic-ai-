<!--
UAI-COS SPEC — PHOENIX RISING V2.0 QUANT RESEARCH & ALGORITHMIC TRADING (imported VERBATIM)
Source        : user message (Arena chat), 2026-09-23 — poora Phoenix Rising V2.0 quant prompt user ne khud paste kiya
Imported on   : 2026-09-23 (Asia/Kolkata)
Extraction    : direct paste — ek shabd nahi badla
Content hash  : sha256:91fd45775607c619
Sections      : 53 sections (0-52) + 3 research extensions (protocol, thresholds, data policy)
Status        : CANONICAL — verbatim. Edit nahi karte; naya version = nayi file.
Apply engine  : python3 tools/apply_phase.py --spec phoenix
Raw copy      : 00_SYSTEM/_raw/prompt_phoenix_rising_v2_raw.md
-->

> **Import note:** Ye user ke **PHOENIX RISING V2.0** prompt ka poora, uncut text hai —
> Autonomous Quant Research, Strategy Discovery, Backtesting, Risk Management, Mathematical Feasibility ($10k->$1M),
> Walk-Forward, Monte Carlo, Adversarial Red-Teaming, 11-agent quant architecture, aur No-Martingale / Survival rules.
