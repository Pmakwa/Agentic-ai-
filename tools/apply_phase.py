...
SPECS: dict[str, dict] = {
    ...
    "phoenix": {
        ...
        "checks": [("spec import + hash", c_spec("00_SYSTEM/05_PHOENIX_RISING_V2_QUANT_SPEC.md", "91fd45775607c619")),
                   ...
                   ("production strategy spec", c_spec("09_QUANT_RESEARCH/PRODUCTION_STRATEGY_SPEC.md")),
                   ("actual trade log", c_spec("09_QUANT_RESEARCH/TRADE_LOG.csv")),
                   ("backtest results json", c_spec("09_QUANT_RESEARCH/BACKTEST_RESULTS.json")),
                   ("strategy engine tool", c_spec("tools/phoenix_strategy_engine.py")),
                   ("intraday master manual", c_spec("09_QUANT_RESEARCH/PHOENIX_INTRADAY_MASTER_MANUAL.md")),
                   ("intraday trade log", c_spec("09_QUANT_RESEARCH/INTRADAY_TRADE_LOG.csv")),
                   ("intraday backtest json", c_spec("09_QUANT_RESEARCH/INTRADAY_BACKTEST_RESULTS.json")),
                   ("intraday engine tool", c_spec("tools/phoenix_intraday_engine.py")),
